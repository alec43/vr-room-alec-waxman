...
public class ProximityZone : MonoBehaviour
{
    ...
    private void OnTriggerEnter(Collider other)
    {
        ...
        if (other.CompareTag("MainCamera"))
        {
            ...
            GalleryEventHub.Instance.Emit(GalleryEventTypes.ProximityEnter, "zone_1");
        }
    }
    ...
    private void OnTriggerExit(Collider other)
    {
        if (other.CompareTag("MainCamera"))
        {
            ...
            GalleryEventHub.Instance.Emit(GalleryEventTypes.ProximityExit, "zone_1");
        }
    }
    ...
    private void StartVideo()
    {
        ...
        if (videoQuad != null)
        {
            ...
            videoPlayer?.Play();
            isPlaying = true;
            GalleryEventHub.Instance.Emit(GalleryEventTypes.VideoPlay, "video_1");
        }
    }
    ...
    private void StopVideo()
    {
        ...
        {
            videoPlayer?.Stop();
            if (isPlaying) GalleryEventHub.Instance.Emit(GalleryEventTypes.VideoStop, "video_1");
            isPlaying = false;
